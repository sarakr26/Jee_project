...
<body>
    <div class="messages-container">
        <div class="messages-card">
            ...
            <div class="tabs">
                <a href="${pageContext.request.contextPath}/messages?action=inbox" class="tab-link active">
                    <i class="fas fa-inbox"></i> Réception
                </a>
                <a href="${pageContext.request.contextPath}/messages?action=sent" class="tab-link">
            ...
            <c:choose>
                <c:when test="${empty messages}">
                    <div class="empty">
                        <i class="fas fa-envelope-open-text" style="font-size: 2rem; margin-bottom: 10px;"></i>
