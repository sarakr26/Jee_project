...
<head>
    ...
    <title>Chess Club Manager - Créer un événement</title>
                ...
                <div class="event-form-card">
                    ...
                    <div class="form-header">
                        <div class="chess-logo">
                            ...
                            <p>Planifier un nouvel événement pour votre club</p>
                        </div>
                    </div>
                        ...
                        <div class="form-layout">
                            <div class="form-group">
                                ...
                                <div class="form-input-group">
                                    ...
                                    <input type="text" name="titre" value="${param.titre}" class="form-input" placeholder="Entrez le titre de l'événement" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input-group">
                                    ...
                                    <input type="text" name="lieu" value="${param.lieu}" class="form-input" placeholder="Lieu de l'événement">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-layout-single">
                            <div class="form-group">
                                ...
                                <div class="form-textarea-group">
                                    <textarea name="description" class="form-textarea" placeholder="Description détaillée de l'événement...">${param.description}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-layout">
                            <div class="form-group">
                                ...
                                <div class="form-input-group">
                                    ...
                                    <input type="date" name="dateDebut" value="${param.dateDebut}" class="form-input">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input-group">
                                    ...
                                    <input type="date" name="dateFin" value="${param.dateFin}" class="form-input">
                                </div>
                            </div>
                        </div>
